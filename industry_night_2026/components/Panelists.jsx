...
const PANELISTS = {
  research: [
    { id:'r1', name:'Dr Lana Tikhomirov', image:'assets/event/1. Dr Lana Tikhomirov (AIML).jpeg', title:'Medical AI Researcher', org:'Adelaide University · AIML', bio:'Researches medical decision-making with AI at AIML, bringing together human factors, cognitive science, bioethics and AI safety to understand how clinical AI can support expert judgement.', focus:['Medical AI','Human Factors','AI Safety'] },
    { id:'r2', name:'Dr Olaf Maennel', image:'assets/event/2. Dr Olaf Maennel (Cyberlab).jpg', title:'Joint Chair in Cybersecurity', org:'Adelaide University · CyberLab', bio:'Leads cybersecurity research and education through a CyberLab cyber range focused on critical infrastructure, adversary emulation, security operations and AI-enabled cyber defence.', focus:['Cybersecurity','Cyber Range','Critical Infra'] },
    { id:'r3', name:'Dr Claire Hayward', image:'assets/event/3. Dr Claire Hayward.jpg', title:'Research Fellow', org:'Adelaide University · Future Industries Institute', bio:'Researches antimicrobial resistance, microbiology, health and ecological risk, with work spanning drinking water systems, plumbing biofilms and public-health implications of water infrastructure.', focus:['AMR','Water Systems','Microbiology'] },
    { id:'r4', name:'Dr Mohsen Dorraki', image:'assets/event/4. Dr Mohsin Dorraki.jpeg', title:'Lecturer', org:'Adelaide University · Computer Science', bio:'Works at the intersection of medical machine learning and signal processing, developing data-driven methods for complex biological and health challenges with translational AI collaborations.', focus:['Medical ML','Signal Processing','Health AI'] },
    { id:'r5', name:'Dr Anthony Mays', image:'assets/event/5. Dr Anthony Mays.jpeg', title:'Lecturer', org:'Adelaide University · Mathematical Sciences', bio:'Researches statistical physics, random matrix theory and combinatorics, with teaching across masters-level probability and data science.', focus:['Mathematics','Random Matrices','Data Science'] },
  ],
  industry: [
    { id:'i1', name:'Matthew Hobson', image:'assets/event/Matthew Hobson (Databricks).jpg', title:'Senior Leader', org:'Databricks', bio:'Works with organisations on the real-world path to scaled AI, with public commentary around data access, AI adoption, trust and measurable value through the Databricks ecosystem.', focus:['Data + AI','Lakehouse','AI Strategy'] },
    { id:'i2', name:'Kat Docking', image:'assets/event/Kat Docking (SA Power Networks).jpg', title:'Digital & Technology Graduate', org:'SA Power Networks', bio:'A Digital and Technology Graduate at SA Power Networks, South Australia’s electricity distributor, with early project experience connecting software, asset data and infrastructure insight.', focus:['Digital Tech','Utilities','Energy'] },
    { id:'i3', name:'Binduja Sasi', image:'assets/event/Binduja Sasi (Dept of Infrastructure & Transport).jpg', title:'Procurement Professional', org:'Dept for Infrastructure & Transport', bio:'A procurement professional at South Australia’s Department for Infrastructure and Transport, working across goods, services and construction in a large public infrastructure environment.', focus:['Procurement','Infrastructure','Public Sector'] },
    { id:'i4', name:'Toby Lewis', image:'assets/event/Toby Lewis (Dept of Treasury & Finance).jpg', title:'Digital Strategy Executive', org:'Dept of Treasury & Finance', bio:'A solutions-focused senior executive with digital strategy expertise at South Australia’s Department of Treasury and Finance, where digital services support public value and state outcomes.', focus:['Digital Strategy','Government','Investment'] },
